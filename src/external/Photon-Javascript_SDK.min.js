var __extends =
    ...
    Photon;
(function (k) {
    k.ConnectionProtocol = { Ws: 0, Wss: 1 };
    var a = (function () {
        function a(n, b, h) {
            void 0 === b && (b = '');
            void 0 === h && (h = '');
            ...
            this._logger = new Exitgames.Common.Logger(
                h && '' != h ? h + ':' : ''
            );
        }
        ...
        a.prototype.connect = function () {
            ...
            this._socket.onclose = function (b) {
                ...
                a._isConnecting
                    ? a._onConnectFailed(b)
                    : (1006 == b.code && a._onTimeout(), a._onDisconnect());
            };
        ...
        a.prototype.sendOperation = function (a, b, h, g) {
            ...
            if (Exitgames.Common.Util.isArray(b)) a.vals = b;
                ...
                throw Error(
                    this._logger.format(
                        'PhotonPeer[sendOperation] - Trying to send non array data:',
                        b
                    )
                );
            this._send(a);
            this._logger.debug(
                'PhotonPeer[sendOperation] - Sending request:',
                a
            );
        };
        ...
        a.prototype.removeEventListener = function (a, b) {
            this._removeListener(this._eventListeners, a.toString(), b);
        };
        ...
        a.prototype.onUnhandledEvent = function (a, b) {
            this._logger.warn(
                'PhotonPeer: No handler for event',
                a,
                'registered.'
            );
        };
        a.prototype.onUnhandledResponse = function (a, b) {
            this._logger.warn(
                'PhotonPeer: No handler for response',
                a,
                'registered.'
            );
        };
        a.prototype._dispatchEvent = function (a, b) {
            if (!this._dispatch(this._eventListeners, a.toString(), b, 'event'))
                this.onUnhandledEvent(a, b);
        };
            ...
            for (var g = 0, l = a.length; g < l; g++)
                (h =
                    null === a[g] || void 0 === a[g]
                        ? ''
                        : this._stringify(a[g])),
                    (b += this._frame + h.length + this._frame + h);
            return b;
        };
        a.prototype._decode = function (a) {
            var b = [],
                ...
                g;
            h = a;
            -1 !== a.indexOf('\x00') && (h = a.replace(/[\0]/g, ''));
            a = h;
            do {
                ...
                for (var l = 0, k = a.length; l < k; l++)
                    if (((g = Number(a.substr(l, 1))), a.substr(l, 1) == g))
                        h += g;
                    else {
        ...
        a.prototype._onMessage = function (a) {
            '~j~' == a.substr(0, 3)
                ? this._onMessageReceived(JSON.parse(a.substr(3)))
                : this._sessionid
                ? this._onMessageReceived(a)
                : ((this._sessionid = a), this._onConnect());
        };
        a.prototype.resetKeepAlive = function () {
            ...
            1e3 <= this.keepAliveTimeoutMs &&
                (this.keepAliveTimer = setTimeout(function () {
                    return a._send({ irq: 1, vals: [1, Date.now()] }, !0);
        ...
        a.prototype._send = function (a, b) {
            ...
            if (this._isConnected && !this._isClosing)
                this.resetKeepAlive(), this._socket.send(h);
            else if (!b)
                throw Error(
                    this._logger.format(
        ...
        a.prototype._onMessageReceived = function (a) {
            if ('object' === typeof a)
                if (
                    (this._logger.debug(
                        'PhotonPeer[_onMessageReceived] - Socket received message:',
                        a
                    ),
                    (a.vals = void 0 !== a.vals ? a.vals : []),
                    0 < a.vals.length &&
                        (a.vals = this._parseMessageValuesArrayToJSON(a.vals)),
                    void 0 !== a.res)
                ) {
                    var b = parseInt(a.res);
                    this._parseResponse(b, a);
                } else if (void 0 !== a.evt)
                    (b = parseInt(a.evt)), this._parseEvent(b, a);
                else if (void 0 !== a.irs)
                    (b = parseInt(a.irs)), this._parseInternalResponse(b, a);
                else
                    throw Error(
                        this._logger.format(
        ...
        a.prototype._parseMessageValuesArrayToJSON = function (a) {
            ...
            if (Exitgames.Common.Util.isArray(a))
                if (0 == a.length % 2)
                    for (var h, g; 0 < a.length; )
                        (h = a.shift() + ''), (g = a.shift()), (b[h] = g);
                else
                    throw Error(
                        this._logger.format(
        ...
        a.prototype._parseEvent = function (a, b) {
            switch (a) {
                default:
                    this._dispatchEvent(a, { vals: b.vals });
            }
        };
        ...
        a.prototype._onConnect = function () {
            this._logger.debug(
                'PhotonPeer[_onConnect] - Connected successfully! Raising "connect" event ...'
            );
        ...
        a.prototype._onDisconnect = function () {
            var n = this._isConnected,
                b = this._isClosing;
            this._logger.debug(
                'PhotonPeer[_onDisconnect] - Socket closed, raising "disconnect" event ...'
            );
            this._isClosing = this._isConnected = this._isConnecting = !1;
            n &&
                (b
                    ? this._dispatchPeerStatus(a.StatusCodes.disconnect)
                    : this._dispatchPeerStatus(a.StatusCodes.connectClosed));
        };
        a.prototype._onTimeout = function () {
            this._logger.debug(
                'PhotonPeer[_onTimeout] - Client timed out! Raising "timeout" event ...'
            );
        ...
        a.prototype._addListener = function (a, b, h) {
            ...
            h && 'function' === typeof h
                ? (this._logger.debug(
                      'PhotonPeer[_addListener] - Adding listener for event',
                      b
                  ),
                  a[b].push(h))
                : this._logger.error(
        ...
        a.prototype._dispatch = function (a, b, h, g) {
            if (b in a) {
                ...
                for (g = a.length; b < g; b++)
                    Exitgames.Common.Util.isArray(h) || (h = [h]),
                        a[b].apply(this, void 0 === h ? [] : h);
                return !0;
            }
            return !1;
        };
        a.prototype._dispatchPeerStatus = function (a) {
            this._dispatch(
                this._peerStatusListeners,
                a,
                void 0,
                ...
                this._logger.warn(
                    'PhotonPeer[_dispatchPeerStatus] - No handler for ',
                    a,
                    'registered.'
                );
        };
        ...
        a.prototype._removeListenersForCode = function (a, b) {
            this._logger.debug(
                'PhotonPeer[_removeListenersForCode] - Removing all listeners for event',
                b
            );
            b in a && (a[b] = []);
            return this;
...
(function (k) {
    (function (a) {
        var k = (function () {
            ...
            a.prototype.log = function (b, h, g) {
                if (
                    b >= this.level &&
                    ...
                    try {
                        ...
                        l &&
                            (l.call
                                ? l.call(console, this.format0(h, g))
                                : l(console, this.format0(h, g)));
                    } catch (k) {}
            };
            ...
            a.Level = { DEBUG: 1, INFO: 2, WARN: 3, ERROR: 4, OFF: 6 };
        ...
        k = (function () {
            ...
            a.enumValueToName = function (a, h) {
                for (var g in a) if (h == a[g]) return g;
                return 'undefined';
            };
...
(function (k) {
    ...
    k.LiteEventCode = { Join: 255, Leave: 254, PropertiesChanged: 253 };
    k.LiteOpCode = {
        ChangeGroups: 248,
        GetProperties: 251,
        Join: 255,
    ...
    (function (a) {
        var m = (function (m) {
            function b(a, g) {
                ...
                this.addPeerStatusListener(
                    k.PhotonPeer.StatusCodes.disconnect,
                    function () {
                        b.isJoined = !1;
                    }
                );
            ...
            b.prototype.join = function (h, g, b, k) {
                if (void 0 !== h && this.isConnected() && !this.isJoined) {
                    this._logger.info(
                        'PhotonPeer.Lite[join] - Joining roomName:',
                        h
                    );
                    this._logger.debug(
                        'PhotonPeer.Lite[join] - actorProperties:',
                        b,
                        ', roomProperties:',
                        g,
                        ', broadcast:',
                    ...
                    p.push(h + '');
                    'object' === typeof g &&
                        (p.push(a.Constants.LiteOpKey.GameProperties),
                        p.push(g));
                    'object' === typeof b &&
                        (p.push(a.Constants.LiteOpKey.ActorProperties),
                        p.push(b));
                    ...
                    if (void 0 === h)
                        throw Error(
                            'PhotonPeer.Lite[join] - Trying to join with undefined roomName!'
                        );
                    if (this.isJoined)
                        throw Error(
                            'PhotonPeer.Lite[join] - you have already joined!'
                        );
            ...
            b.prototype.leave = function () {
                if (this.isJoined)
                    this._logger.debug('PhotonPeer.Lite[leave] - Leaving ...'),
                        this.sendOperation(a.Constants.LiteOpCode.Leave);
            ...
            b.prototype.raiseEvent = function (h, g) {
                if (this.isJoined)
                    if (void 0 !== g)
                        this._logger.debug(
                            'PhotonPeer.Lite[raiseEvent] - Event',
                            h,
                            ':',
                            g
                        ),
                            this.sendOperation(
                                a.Constants.LiteOpCode.RaiseEvent,
                                [
                                    a.Constants.LiteOpKey.Code,
                                    h,
                                    a.Constants.LiteOpKey.Data,
                                    g
                                ]
                            );
                    else
            ...
            b.prototype.setActorProperties = function (h, g, b) {
                if (this.isJoined)
                    this._logger.debug(
                        'PhotonPeer.Lite[setActorProperties] - actorNumber:' +
                            h +
                            ', broadcast:' +
                            b +
                            ', data:',
                        ...
                        this.sendOperation(
                            a.Constants.LiteOpCode.SetProperties,
                            [
                                a.Constants.LiteOpKey.Broadcast,
                                b,
                                a.Constants.LiteOpKey.Properties,
                                g,
                                a.Constants.LiteOpKey.ActorNr,
                                h
                            ]
                        );
                else
                    throw Error(
                        'PhotonPeer.Lite[setActorProperties] - Not joined!'
                    );
            };
            b.prototype.getActorProperties = function (h, g) {
                if (this.isJoined) {
                    ...
                    void 0 !== h &&
                        Exitgames.Common.Util.isArray(h) &&
                        0 < h.length &&
                        b.push(h);
                    2 !== b.length && b.push(null);
                    b.push(a.Constants.LiteOpKey.ActorList);
                    void 0 !== g &&
                        Exitgames.Common.Util.isArray(g) &&
                        0 < g.length &&
                        b.push(g);
                    ...
                    b.push(2);
                    this._logger.debug(
                        'PhotonPeer.Lite[getActorProperties] -',
                        b
                    );
                    this.sendOperation(a.Constants.LiteOpCode.GetProperties, b);
                } else
                    throw Error('PhotonPeer.Lite[getProperties] - Not joined!');
            };
            b.prototype.setRoomProperties = function (h, g) {
                if (this.isJoined)
                    this._logger.debug(
                        'PhotonPeer.Lite[setRoomProperties] - broadcast:' +
                            g +
                            ', data:',
                        h
                    ),
                    ...
                    throw Error(
                        'PhotonPeer.Lite[setRoomProperties] - Not joined!'
                    );
            };
            b.prototype.getRoomProperties = function (h) {
                if (this.isJoined) {
                    ...
                    void 0 !== h
                        ...
                        : g.push(null);
                    this._logger.debug(
                        'PhotonPeer.Lite[getRoomProperties] -',
                        g
                    );
                    this.sendOperation(a.Constants.LiteOpCode.GetProperties, g);
                } else
                    throw Error(
                        'PhotonPeer.Lite[getRoomProperties] - Not joined!'
                    );
            };
            b.prototype._addActor = function (a) {
                this.actors[a] = { photonId: a };
                this._logger.debug(
                    'PhotonPeer.Lite[_addActor] - Added actorNr',
                    a,
                    'actors known are now ',
                    this.actors
                );
            ...
            b.prototype._removeActor = function (a) {
                ...
                this._logger.debug(
                    'PhotonPeer.Lite[_removeActor] - Removed actorNr',
                    a,
                    ', actors known are now',
                    this.actors
                );
            ...
            b.prototype._parseEvent = function (b, g) {
                ...
                switch (b) {
                    ...
                    default:
                        this._logger.info(
                            'PhotonPeer.Lite[_parseEvent] - Unknown event code',
                            b,
                            'with JSON:',
                            g
                        ),
            ...
            b.prototype._onEventJoin = function (b, g) {
                if (g !== this._myActor.photonId)
                    this._logger.debug(
                        'PhotonPeer.Lite[_onEventJoin] - ActorNr',
                        g,
                        'joined.'
                    ),
                        this._addActor(g),
                    ...
                    for (p in l)
                        (g = parseInt(l[p])),
                            g !== this._myActor.photonId &&
                                void 0 === this.actors[g] &&
                                (this._logger.debug(
                                    'PhotonPeer.Lite[_onEventJoin] - ActorNr',
                                    g,
                                    'registered as already joined'
                                ),
                                this._addActor(g),
                                k.push(g));
                    this._dispatchEvent(a.Constants.LiteEventCode.Join, {
            ...
            b.prototype._onEventLeave = function (b) {
                this._logger.debug(
                    'PhotonPeer.Lite[_onEventLeave] - ActorNr',
                    b,
                    'left'
                );
                this._removeActor(b);
            ...
            b.prototype._parseResponse = function (b, g) {
                ...
                switch (b) {
                    ...
                    default:
                        this._logger.debug(
                            'PhotonPeer.Lite[_parseResponse] - Unknown response code',
                            b,
                            g,
                            'actorNr',
                            l
                        ),
                            this._dispatchResponse(b, {
                                errCode: g.err,
                                errMsg: g.msg,
                                vals: g.vals,
                                actorNr: l
            ...
            b.prototype._onResponseGetProperties = function (b) {
                this._logger.debug(
                    'PhotonPeer.Lite[_onResponseGetProperties] - getProperties response:',
                    b
                );
                ...
                void 0 !== b.vals[a.Constants.LiteOpKey.GameProperties] &&
                    (this.room.properties =
            ...
            b.prototype._onResponseJoin = function (b) {
                this.isJoined = !0;
                'object' === typeof this._myActor &&
                    ((this._myActor = this._addActor(b)),
                    this._logger.debug(
                        'PhotonPeer.Lite[_onResponseJoin] - You joined as actor number / myActor.photonId has been set to:',
                        this._myActor.photonId
                    ));
            ...
            b.prototype._onResponseLeave = function (b) {
                ...
                this._logger.debug(
                    'PhotonPeer.Lite[_onResponseLeave] - You left the room',
                    this.roomName
                );
                this.roomName = '';
                this.room = { properties: {} };
            ...
            b.prototype._onResponseSetProperties = function (b, g) {
                this._logger.debug(
                    'PhotonPeer.Lite[_onResponseSetProperties] - setProperties response:',
                    b,
                    'actorNr',
                    g
                );
...
(function (k) {
    ...
    a.MatchmakingMode = { FillRoom: 0, SerialMatching: 1, RandomMatching: 2 };
    a.EventCaching = {
        DoNotCache: 0,
        MergeCache: 1,
        ReplaceCache: 2,
    ...
    a.ReceiverGroup = { Others: 0, All: 1, MasterClient: 2 };
    ...
    a.LobbyType = { Default: 0, SqlLobby: 2 };
})(Photon || (Photon = {}));
(function (k) {
    (function (a) {
        function m(a, f) {
            for (var c in n) if (0 == a.indexOf(n[c])) return a;
            switch (f) {
            ...
            b = (function () {
                ...
                d.prototype.raiseEvent = function (a, c, e) {
                    this.loadBalancingClient &&
                        this.loadBalancingClient.raiseEvent(a, c, e);
                };
                ...
                d.prototype.getCustomPropertyOrElse = function (a, c) {
                    return Exitgames.Common.Util.getPropertyOrElse(
                        this.customProperties,
                        a,
                        c
                    );
                ...
                d.prototype.setCustomProperty = function (a, c, e, d) {
                    ...
                    this.loadBalancingClient &&
                        this.loadBalancingClient.isJoinedToRoom() &&
                        this.loadBalancingClient._setPropertiesOfActor(
                            this.actorNr,
                            b,
                            e,
                            g
                ...
                d.prototype.setCustomProperties = function (a, c, e) {
                    ...
                    var d = {},
                        b;
                    for (b in a)
                        (this.customProperties[b] = a[b]), (d[b] = a[b]);
                    this.loadBalancingClient &&
                        this.loadBalancingClient.isJoinedToRoom() &&
                        this.loadBalancingClient._setPropertiesOfActor(
                            this.actorNr,
                ...
                d.prototype._getAllProperties = function () {
                    ...
                    for (var c in this.customProperties)
                        f[c] = this.customProperties[c];
                    return f;
                };
        ...
        var h = (function () {
            ...
            d.prototype._updateFromMasterResponse = function (f) {
            ...
            d.prototype._updateFromProps = function (f) {
                if (f) {
                    this.maxPlayers = this.updateIfExists(
                        this.maxPlayers,
                        a.Constants.GameProperties.MaxPlayers,
                        f
                    );
                    this.isVisible = this.updateIfExists(
                        this.isVisible,
                        a.Constants.GameProperties.IsVisible,
                        f
                    );
                    this.isOpen = this.updateIfExists(
                        this.isOpen,
                        a.Constants.GameProperties.IsOpen,
                        f
                    );
                    this.playerCount = this.updateIfExists(
                        this.playerCount,
                        a.Constants.GameProperties.PlayerCount,
                        f
                    );
                    this.removed = this.updateIfExists(
                        this.removed,
                        a.Constants.GameProperties.Removed,
                        f
                    );
                    this._propsListedInLobby = this.updateIfExists(
                        this._propsListedInLobby,
                        a.Constants.GameProperties.PropsListedInLobby,
                        f
                    );
                    this.cleanupCacheOnLeave = this.updateIfExists(
                        this.cleanupCacheOnLeave,
                        a.Constants.GameProperties.CleanupCacheOnLeave,
                        f
                    );
                    this.masterClientId = this.updateIfExists(
                        this.masterClientId,
                        a.Constants.GameProperties.MasterClientId,
                        f
                    );
                    var c = {},
                        e;
                    for (e in f)
                        parseInt(e).toString() != e &&
                            this._customProperties[e] !== f[e] &&
                            ((this._customProperties[e] = f[e]), (c[e] = f[e]));
            ...
            d.prototype._updateFromEvent = function (f) {
                f &&
                    (this.masterClientId = this.updateIfExists(
                        this.masterClientId,
                        a.Constants.ParameterCode.MasterClientId,
                        f
                    ));
            };
        ...
        var g = (function (d) {
            ...
            f.prototype.setCustomProperty = function (a, f, d, b) {
                ...
                this.loadBalancingClient &&
                    this.loadBalancingClient.isJoinedToRoom() &&
                    this.loadBalancingClient._setPropertiesOfRoom(g, d, h);
            ...
            f.prototype.setCustomProperties = function (a, f, d) {
                ...
                this.loadBalancingClient &&
                    this.loadBalancingClient.isJoinedToRoom() &&
                    this.loadBalancingClient._setPropertiesOfRoom(b, f, d);
                this.onPropertiesChange(b, !0);
            };
            f.prototype.setProp = function (a, f) {
                if (
                    this.loadBalancingClient &&
                    this.loadBalancingClient.isJoinedToRoom()
                ) {
                    var d = {};
                    d[a] = f;
                    this.loadBalancingClient._setPropertiesOfRoom(
                        d,
                        !1,
                        void 0
                    );
            ...
            f.prototype.setIsVisible = function (f) {
                this.isVisible != f &&
                    ((this.isVisible = f),
                    this.setProp(a.Constants.GameProperties.IsVisible, f));
            };
            f.prototype.setIsOpen = function (f) {
                this.isOpen != f &&
                    ((this.isOpen = f),
                    this.setProp(a.Constants.GameProperties.IsOpen, f));
            };
            f.prototype.setMaxPlayers = function (f) {
                this.maxPlayers != f &&
                    ((this.maxPlayers = f),
                    this.setProp(a.Constants.GameProperties.MaxPlayers, f));
            };
        ...
        var l = (function () {
            function d(f, c, e) {
                ...
                this.validNextState = {};
                if ('number' == typeof f)
                    switch (((this.connectionProtocol = f), f)) {
                        case k.ConnectionProtocol.Ws:
                            this.masterServerAddress =
                                'ws://app-eu.exitgamescloud.com:9090';
                            this.nameServerAddress =
                                'ws://ns.exitgames.com:9093';
                            break;
                        case k.ConnectionProtocol.Wss:
                            this.masterServerAddress =
                                'wss://app-eu.exitgamescloud.com:19090';
                            this.nameServerAddress =
                                'wss://ns.exitgames.com:19093';
                            break;
                        default:
                            (this.nameServerAddress = this.masterServerAddress =
                                'wrong_protocol_error'),
                                this.logger.error('Wrong protocol: ', f);
                    }
                else
                    'string' == typeof f
                        ? ((this.connectionProtocol = k.ConnectionProtocol.Ws),
                          (this.nameServerAddress = this.masterServerAddress =
                              f))
                        : ((this.connectionProtocol = k.ConnectionProtocol.Ws),
                          (this.nameServerAddress = this.masterServerAddress =
                              'wrong_protocol_type_error'),
                          this.logger.error('Wrong protocol type: ', typeof f));
            ...
            d.prototype.onRoomListUpdate = function (a, c, e, d) {};
            ...
            d.prototype.onWebRpcResult = function (a, c, e, d, b) {};
            ...
            d.prototype.setCustomAuthentication = function (a, c, e) {
                void 0 === c &&
                    (c =
                        k.LoadBalancing.Constants.CustomAuthenticationType
                            .Custom);
                this.userAuthType = c;
            ...
            d.prototype.connect = function (a) {
                ...
                a || (a = {});
                if (this.checkNextState(d.State.ConnectingToMasterserver, !0)) {
                    ...
                    this.masterPeer = new p(
                        this,
                        m(this.masterServerAddress, this.connectionProtocol),
                        ''
                    );
            ...
            d.prototype.connectToNameServer = function (a) {
                ...
                if (this.checkNextState(d.State.ConnectingToNameServer, !0)) {
                    ...
                    this.connectOptions = {};
                    for (var c in a) this.connectOptions[c] = a[c];
                    this.nameServerPeer = new r(
                        this,
                        m(this.nameServerAddress, this.connectionProtocol),
                        ''
                    );
            ...
            d.prototype.fillCreateRoomOptions = function (f, c) {
                ...
                var e = {};
                void 0 !== c.isVisible &&
                    (e[a.Constants.GameProperties.IsVisible] = c.isVisible);
                void 0 !== c.isOpen &&
                    (e[a.Constants.GameProperties.IsOpen] = c.isOpen);
                void 0 !== c.maxPlayers &&
                    (e[a.Constants.GameProperties.MaxPlayers] = c.maxPlayers);
                void 0 !== c.propsListedInLobby &&
                    (e[a.Constants.GameProperties.PropsListedInLobby] =
                        c.propsListedInLobby);
                if (void 0 !== c.customGameProperties)
                    for (var d in c.customGameProperties)
                        e[d] = c.customGameProperties[d];
                ...
                void 0 !== c.emptyRoomLiveTime &&
                    f.push(
                        a.Constants.ParameterCode.EmptyRoomTTL,
                        c.emptyRoomLiveTime
                    );
                void 0 !== c.suspendedPlayerLiveTime &&
                    f.push(
                        a.Constants.ParameterCode.PlayerTTL,
                        c.suspendedPlayerLiveTime
                    );
                void 0 !== c.uniqueUserId &&
                    f.push(
                        a.Constants.ParameterCode.CheckUserOnJoin,
                        c.uniqueUserId
                    );
                c.lobbyName &&
                    (f.push(a.Constants.ParameterCode.LobbyName),
                    f.push(c.lobbyName),
                    void 0 != c.lobbyType &&
                        (f.push(a.Constants.ParameterCode.LobbyType),
                        f.push(c.lobbyType)));
            };
            ...
            d.prototype.joinRoom = function (f, c, e) {
                ...
                c &&
                    (c.createIfNotExists &&
                        (b.push(
                            a.Constants.ParameterCode.JoinMode,
                            d.JoinMode.CreateIfNotExists
                        ),
                        this.fillCreateRoomOptions(b, e)),
                    c.joinToken &&
                        (b.push(
                            a.Constants.ParameterCode.ActorNr,
                            parseInt(c.joinToken)
                        ),
                        b.push(
                            a.Constants.ParameterCode.JoinMode,
                            d.JoinMode.Rejoin
                ...
                b.push(a.Constants.ParameterCode.RoomName, f);
                this.joinRoomOptions = c || {};
                this.createRoomOptions = e || {};
                this.logger.info('Join Room', f, c, e, '...');
                this.masterPeer.sendOperation(
                    a.Constants.OperationCode.JoinGame,
                    b
                );
                return !0;
            };
            d.prototype.joinRandomRoom = function (f) {
                var c = [];
                if (f) {
                    void 0 != f.matchingType &&
                        f.matchingType !=
                            a.Constants.MatchmakingMode.FillRoom &&
                        (c.push(a.Constants.ParameterCode.MatchMakingType),
                        c.push(f.matchingType));
                    var e = {},
                        d = !1;
                    if (void 0 != f.expectedCustomRoomProperties)
                        for (var b in f.expectedCustomRoomProperties)
                            (e[b] = f.expectedCustomRoomProperties[b]),
                                (d = !0);
                    void 0 != f.expectedMaxPlayers &&
                        0 < f.expectedMaxPlayers &&
                        ((e[a.Constants.GameProperties.MaxPlayers] =
                            f.expectedMaxPlayers),
                        (d = !0));
                    d &&
                        (c.push(a.Constants.ParameterCode.GameProperties),
                        c.push(e));
                    f.lobbyName &&
                        (c.push(a.Constants.ParameterCode.LobbyName),
                        c.push(f.lobbyName),
                        void 0 != f.lobbyType &&
                            (c.push(a.Constants.ParameterCode.LobbyType),
                            c.push(f.lobbyType)));
                    f.sqlLobbyFilter &&
                        (c.push(a.Constants.ParameterCode.Data),
                        c.push(f.sqlLobbyFilter));
                }
                this.logger.info(
                    'Join Random Room',
                    f && f.lobbyName,
            ...
            d.prototype._setPropertiesOfRoom = function (f, c, e) {
                ...
                e &&
                    (d.push(a.Constants.ParameterCode.ExpectedValues),
                    d.push(e));
                this.gamePeer.sendOperation(
                    a.Constants.OperationCode.SetProperties,
                    d
                );
            };
            d.prototype._setPropertiesOfActor = function (f, c, e, d) {
                var b = [];
                ...
                d &&
                    (b.push(a.Constants.ParameterCode.ExpectedValues),
                    b.push(d));
                this.gamePeer.sendOperation(
                    a.Constants.OperationCode.SetProperties,
                    b
            ...
            d.prototype.suspendRoom = function () {
                this.isJoinedToRoom() &&
                    ...
                    this.isConnectedToMaster()
                        ? this.changeState(d.State.JoinedLobby)
                        : (this.changeState(d.State.Disconnected),
            ...
            d.prototype.leaveRoom = function () {
                this.isJoinedToRoom() &&
                    (this.gamePeer &&
                        (this.gamePeer.sendOperation(
                            a.Constants.OperationCode.Leave
                        ),
            ...
            d.prototype.changeGroups = function (a, c) {
                this.isJoinedToRoom() &&
                    (this.logger.debug('Group change:', a, c),
                    this.gamePeer.changeGroups(a, c));
            };
                    ...
                    if (a && 'object' == typeof a) {
                        ...
                        for (var c = 0; c < a.length; ++c)
                            if ('string' == typeof a[c])
                                this.findFriendsRequestList[c] = a[c];
                            else {
                                this.logger.error(
                                    'FindFriends request error:',
                                    'Friend name is not a string',
                                    c
                                );
                                this.onFindFriendsResult(
                                    1101,
                                    'Friend name is not a string ' + c,
                                    {}
                                );
                                return;
                            }
                        this.logger.debug('Find friends:', a);
                        this.masterPeer.findFriends(
                            this.findFriendsRequestList
                        );
                    } else
                        this.logger.error(
            ...
            d.prototype.requestLobbyStats = function (f) {
                if (this.isConnectedToMaster()) {
                        ...
                        if ('object' == typeof f)
                            for (var c = 0; c < f.length; ++c) {
                                ...
                                if ('object' == typeof e) {
                                    ...
                                    if (d) {
                                        if (void 0 === e[1])
                                            e = a.Constants.LobbyType.Default;
                                        else if ('number' == typeof e[1])
                                            e = e[1];
                                        else {
                                            this.requestLobbyStatsErr(
                                                'Lobby type is invalid',
                                                c
                                            );
                                            return;
                                        }
                                        this.lobbyStatsRequestList[c] = [
                                            d.toString(),
                                            e
                                        ];
                                    } else {
                    ...
                    this.masterPeer.requestLobbyStats(
                        this.lobbyStatsRequestList
                    );
                } else
                    this.logger.error(
                        'LobbyState request error:',
                        'Not connected to Master'
                    ),
            ...
            d.prototype.webRpc = function (a, c) {
                this.isConnectedToMaster()
                    ? (this.logger.debug('WebRpc...'),
                      this.masterPeer.webRpc(a, c))
                    : this.isJoinedToRoom()
                    ? (this.logger.debug('WebRpc...'),
                      this.gamePeer.webRpc(a, c))
                    : (this.logger.error(
                          'WebRpc request error:',
            ...
            d.prototype.connectToRegionMaster = function (a) {
                ...
                this.logger.error(
                    'Connecting to Region Master error:',
                    'Not connected to NameServer'
                );
                return !1;
            };
            ...
            d.prototype.clearRooms = function () {
                this.roomInfos = [];
                this.roomInfosDict = {};
            };
            d.prototype.purgeRemovedRooms = function () {
                ...
                for (var a in this.roomInfosDict)
                    this.roomInfosDict[a].removed &&
                        delete this.roomInfosDict[a];
            };
            d.prototype.addActor = function (a) {
                ...
                if (0 == this.lowestActorId || this.lowestActorId > a.actorNr)
                ...
                this.lowestActorId == a &&
                    (this.lowestActorId =
                        0 < this.actorsArray.length
                            ? this.actorsArray.reduce(function (a, e) {
            ...
            d.prototype.createRoomInternal = function (f, c) {
                ...
                this.currentRoom.name &&
                    e.push(
                        a.Constants.ParameterCode.RoomName,
                        this.currentRoom.name
                    );
                this.fillCreateRoomOptions(e, c);
                f === this.masterPeer && (this.createRoomOptions = c);
                f === this.gamePeer &&
                    (e.push(a.Constants.ParameterCode.PlayerProperties),
                    e.push(this._myActor._getAllProperties()));
                (f == this.gamePeer
                    ? this.gamePeer._logger
                    : this.masterPeer._logger
                ).info(
                    'Create Room',
                    c && c.lobbyName,
                    c && c.lobbyType,
                ...
                f.sendOperation(a.Constants.OperationCode.CreateGame, e);
            };
            d.prototype.updateUserIdAndNickname = function (f, c) {
                var e = f[a.Constants.ParameterCode.UserId];
                void 0 != e &&
                    (this.setUserId(e),
                    c.info('Setting userId sent by server:', e));
                e = f[a.Constants.ParameterCode.Nickname];
                void 0 != e &&
                    (this.myActor().setName(e),
                    c.info('Setting nickname sent by server:', e));
            };
            d.prototype.initNameServerPeer = function (f) {
                var c = this;
                f.setLogLevel(this.logger.getLevel());
                f.addPeerStatusListener(
                    k.PhotonPeer.StatusCodes.error,
                    function () {
                ...
                f.addPeerStatusListener(
                    k.PhotonPeer.StatusCodes.connectFailed,
                    function () {
                        c.changeState(d.State.Error);
                        c._onErrorInternal(
                            d.PeerErrorCode.NameServerConnectFailed,
                            'NameServer peer connect failed. ' +
                                c.nameServerAddress
                        );
                    }
                );
                f.addPeerStatusListener(
                    k.PhotonPeer.StatusCodes.timeout,
                    function () {
                        c.changeState(d.State.Error);
                        c._onErrorInternal(
                            d.PeerErrorCode.NameServerTimeout,
                            'NameServer peer timeout'
                        );
                    }
                );
                f.addPeerStatusListener(
                    k.PhotonPeer.StatusCodes.connecting,
                    function () {}
                );
                f.addPeerStatusListener(
                    k.PhotonPeer.StatusCodes.connect,
                    function () {
                        f._logger.info('Connected');
                        c.changeState(d.State.ConnectedToNameServer);
                        void 0 != c.connectOptions.region &&
                            f.opAuth(
                                c.appId,
                                c.appVersion,
                                c.userAuthType,
                                c.userAuthParameters,
                                c.userAuthData,
                                c.userId,
                                c.connectOptions.region
                            );
                    }
                );
                f.addPeerStatusListener(
                    ...
                    function () {
                        f == c.nameServerPeer &&
                            (c._cleanupNameServerPeerData(),
                            f._logger.info('Disconnected'));
                    }
                );
                f.addPeerStatusListener(
                    k.PhotonPeer.StatusCodes.connectClosed,
                    function () {
                ...
                f.addResponseListener(
                    a.Constants.OperationCode.GetRegions,
                    function (e) {
                ...
                f.addResponseListener(
                    a.Constants.OperationCode.Authenticate,
                    function (e) {
                        f._logger.debug('resp Authenticate', e);
                        0 == e.errCode
                            ? (f._logger.info('Authenticated'),
                              f.disconnect(),
                              c.updateUserIdAndNickname(e.vals, f._logger),
                              (c.masterServerAddress =
                                  e.vals[a.Constants.ParameterCode.Address]),
                              f._logger.info(
                              ...
                              c.connect({
                                  userAuthSecret:
                                      e.vals[a.Constants.ParameterCode.Secret]
                              }))
                            : (c.changeState(d.State.Error),
                              c._onErrorInternal(
                                  d.PeerErrorCode
            ...
            d.prototype.initMasterPeer = function (f) {
                var c = this;
                f.setLogLevel(this.logger.getLevel());
                f.addPeerStatusListener(
                    k.PhotonPeer.StatusCodes.error,
                ...
                f.addPeerStatusListener(
                    ...
                    function () {
                        c.changeState(d.State.Error);
                        c._onErrorInternal(
                            d.PeerErrorCode.MasterConnectFailed,
                            'Master peer connect failed: ' +
                                c.masterServerAddress
                        );
                    }
                );
                ...
                f.addPeerStatusListener(
                    ...
                    function () {
                        f._logger.info('Connected');
                        var e = [];
                        c.connectOptions.userAuthSecret
                            ? (e.push(
                                  a.Constants.ParameterCode.Secret,
                                  c.connectOptions.userAuthSecret
                              ),
                              f.sendOperation(
                                  a.Constants.OperationCode.Authenticate,
                              ...
                              f._logger.info('Authenticate with secret...'))
                            : (e.push(a.Constants.ParameterCode.ApplicationId),
                              e.push(c.appId),
                              e.push(a.Constants.ParameterCode.AppVersion),
                              e.push(c.appVersion),
                              c.userAuthType !=
                                  a.Constants.CustomAuthenticationType.None &&
                                  (e.push(
                                      a.Constants.ParameterCode
                              ...
                              c.userId &&
                                  e.push(
                                      a.Constants.ParameterCode.UserId,
                                      c.userId
                                  ),
                              c.connectOptions.lobbyStats &&
                                  e.push(
                                      a.Constants.ParameterCode.LobbyStats,
                                      !0
                                  ),
                              f.sendOperation(
                                  a.Constants.OperationCode.Authenticate,
                ...
                f.addEventListener(
                    a.Constants.EventCode.GameList,
                    function (e) {
                ...
                f.addEventListener(
                    a.Constants.EventCode.GameListUpdate,
                    function (e) {
                        e = e.vals[a.Constants.ParameterCode.GameList];
                        var d = [],
                            b = [],
                        ...
                        e.errCode
                            ...
                            : (f._logger.info('Authenticated'),
                              ...
                              void 0 !=
                                  ...
                                  (c.connectOptions.userAuthSecret =
                                      e.vals[a.Constants.ParameterCode.Secret]),
                              c.changeState(d.State.ConnectedToMaster),
                              (e = []),
                              c.connectOptions.lobbyName &&
                                  (e.push(a.Constants.ParameterCode.LobbyName),
                                  e.push(c.connectOptions.lobbyName),
                                  void 0 != c.connectOptions.lobbyType &&
                                      (e.push(
                                          a.Constants.ParameterCode.LobbyType
                                      ),
                                      e.push(c.connectOptions.lobbyType))),
                              c.autoJoinLobby &&
                                  (f.sendOperation(
                                      a.Constants.OperationCode.JoinLobby,
                                      e
                                  ),
                                  f._logger.info(
                                      'Join Lobby',
                                      c.connectOptions.lobbyName,
                                      c.connectOptions.lobbyType,
                                      '...'
                                  )));
                    }
                );
                f.addResponseListener(
                    ...
                    function (e) {
                        ...
                        e.errCode ||
                            (f._logger.info('Joined to Lobby'),
                            c.changeState(d.State.JoinedLobby));
                        c._onOperationResponseInternal2(
                            a.Constants.OperationCode.JoinLobby,
                            e
                        );
                    }
                ...
                f.addResponseListener(
                    ...
                    function (e) {
                        ...
                        e.errCode ||
                            (c.currentRoom._updateFromMasterResponse(e.vals),
                            f._logger.debug(
                                'Created/Joined ' + c.currentRoom.name
                            ),
                ...
                f.addResponseListener(
                    ...
                    function (e) {
                        ...
                        e.errCode ||
                            (c.currentRoom._updateFromMasterResponse(e.vals),
                            f._logger.debug('Joined ' + c.currentRoom.name),
                            c.connectToGameServer(
                                a.Constants.OperationCode.JoinGame
                            ));
                        c._onOperationResponseInternal2(
                ...
                f.addResponseListener(
                    a.Constants.OperationCode.FindFriends,
                    function (e) {
                        ...
                        if (e.errCode)
                            ...
                            for (
                                var b =
                                    ...
                                    h = 0;
                                h < c.findFriendsRequestList.length;
                                ++h
                            ) {
                                var l = c.findFriendsRequestList[h];
                                l && (d[l] = { online: b[h], roomId: g[h] });
                            }
                        c.onFindFriendsResult(e.errCode, e.errMsg, d);
                    }
                );
                f.addResponseListener(
                    a.Constants.OperationCode.LobbyStats,
                    function (e) {
                        f._logger.debug('resp LobbyStats', e);
                        var d = [];
                        if (e.errCode)
                            f._logger.error(
                                'LobbyStats request error:',
                                e.errCode
                            );
                        else {
                            var b = e.vals[a.Constants.ParameterCode.LobbyName],
                                ...
                                h =
                                    e.vals[
                                        a.Constants.ParameterCode.PeerCount
                                    ] || {},
                                l =
                                    e.vals[
                                        a.Constants.ParameterCode.GameCount
                                    ] || {};
                            if (b)
                                ...
                                for (
                                    k = 0;
                                    k < c.lobbyStatsRequestList.length;
                                    ++k
                                )
                                    (b = c.lobbyStatsRequestList[k]),
                                        (d[k] = {
                                            lobbyName: b[0],
                                            lobbyType: b[1],
                                            peerCount: h[k],
                ...
                f.addEventListener(
                    a.Constants.EventCode.LobbyStats,
                    function (e) {
                        f._logger.debug('ev LobbyStats', e);
                        var d = [],
                            b = e.vals[a.Constants.ParameterCode.LobbyName],
                            g =
                                e.vals[a.Constants.ParameterCode.LobbyType] ||
                                {},
                            h =
                                e.vals[a.Constants.ParameterCode.PeerCount] ||
                                {};
                ...
                f.addEventListener(
                    a.Constants.EventCode.AppStats,
                    function (e) {
                        ...
                        c.onAppStats(0, '', {
                            ...
                            masterPeerCount:
                                e.vals[
                                    a.Constants.ParameterCode.MasterPeerCount
                                ],
                            gameCount:
                                e.vals[a.Constants.ParameterCode.GameCount]
                        });
                    }
                );
                f.addResponseListener(
                    a.Constants.OperationCode.Rpc,
                    f.webRpcHandler(this)
                );
            };
            d.prototype.connectToGameServer = function (a) {
                this.connectOptions.keepMasterConnection ||
                    this.masterPeer.disconnect();
                return this.checkNextState(d.State.ConnectingToGameserver, !0)
                    ? (this.logger.info(
                          'Connecting to Game',
                      ...
                      (this.gamePeer = new q(
                          this,
                          m(this.currentRoom.address, this.connectionProtocol),
                          ''
                      )),
                      (this.gamePeerWaitingForDisconnect = !1),
                      this.initGamePeer(this.gamePeer, a),
                      this.gamePeer.connect(),
                      this.changeState(d.State.ConnectingToGameserver),
                      !0)
                    : !1;
            };
            d.prototype.initGamePeer = function (f, c) {
                ...
                f.addPeerStatusListener(
                    ...
                    function () {
                        e.changeState(d.State.Error);
                        e._onErrorInternal(
                            d.PeerErrorCode.GameConnectFailed,
                            'Game peer connect failed: ' + e.currentRoom.address
                        );
                    }
                );
                f.addPeerStatusListener(
                ...
                f.addPeerStatusListener(
                    ...
                    function () {
                        ...
                        c.push(e.appVersion);
                        void 0 != e.connectOptions.userAuthSecret &&
                            (c.push(a.Constants.ParameterCode.Secret),
                        ...
                        e.userAuthType !=
                            ...
                            c.push(e.userAuthType));
                        e.userId &&
                            c.push(a.Constants.ParameterCode.UserId, e.userId);
                        f.sendOperation(
                            a.Constants.OperationCode.Authenticate,
                            c
                        );
                ...
                f.addPeerStatusListener(
                    ...
                    function () {
                        f._logger.info('Server closed connection');
                        e.gamePeerWaitingForDisconnect ||
                            (e.changeState(d.State.Error),
                            e._onErrorInternal(
                                d.PeerErrorCode.MasterConnectClosed,
                ...
                f.addResponseListener(
                    ...
                    function (b) {
                        ...
                        b.errCode
                            ? (e.changeState(d.State.Error),
                              e._onErrorInternal(
                                  d.PeerErrorCode.GameAuthenticationFailed,
                                  'Game authentication failed'
                              ))
                            : (f._logger.info('Authenticated'),
                              f._logger.info('Connected'),
                              c == a.Constants.OperationCode.CreateGame
                                  ? e.createRoomInternal(f, e.createRoomOptions)
                                  : ((b = []),
                                    b.push(a.Constants.ParameterCode.RoomName),
                                    b.push(e.currentRoom.name),
                                    b.push(a.Constants.ParameterCode.Broadcast),
                                    b.push(!0),
                                    b.push(
                                        a.Constants.ParameterCode
                                    ...
                                    b.push(e._myActor._getAllProperties()),
                                    c == a.Constants.OperationCode.JoinGame &&
                                        (e.joinRoomOptions.createIfNotExists &&
                                            (b.push(
                                                a.Constants.ParameterCode
                                                    .JoinMode,
                                                d.JoinMode.CreateIfNotExists
                                            ),
                                            e.fillCreateRoomOptions(
                                                b,
                                                e.createRoomOptions
                                            )),
                                        e.joinRoomOptions.joinToken &&
                                            (b.push(
                                                a.Constants.ParameterCode
                                                    .ActorNr,
                                                parseInt(
                              ...
                              e.changeState(d.State.ConnectedToGameserver));
                    }
                );
                f.addResponseListener(
                    a.Constants.OperationCode.CreateGame,
                    function (c) {
                        ...
                        c.errCode ||
                            ...
                            e.currentRoom._updateFromProps(
                                c.vals[a.Constants.ParameterCode.GameProperties]
                            ),
                            e.clearActors(),
                            e.addActor(e._myActor),
                            e.changeState(d.State.Joined),
                            e.onJoinRoom(!0));
                        e._onOperationResponseInternal2(
                            a.Constants.OperationCode.CreateGame,
                            c
                        );
                    }
                            ...
                            if (void 0 !== b)
                                for (var h in b) {
                                    ...
                                    void 0 !== k &&
                                        (p =
                                            k[
                                                a.Constants.ActorProperties
                                                    .PlayerName
                                            ]);
                                    l == e._myActor.actorNr
                                        ? (l = e._myActor)
                                        : ((l = e.actorFactoryInternal(p, l)),
                                          e.addActor(l));
                                    void 0 !== k &&
                                        l._updateCustomProperties(k);
                                }
                            e.currentRoom._updateFromProps(
                                c.vals[a.Constants.ParameterCode.GameProperties]
                            );
                ...
                f.addEventListener(a.Constants.EventCode.Join, function (a) {
                    ...
                    if (
                        b._getActorNrFromResponse(a.vals) === e._myActor.actorNr
                    )
                        e._myActor._updateFromResponse(a.vals),
                            e.onActorJoin(e._myActor);
                    else {
                ...
                f.addEventListener(a.Constants.EventCode.Leave, function (c) {
                    ...
                    if (d && e.actors[d]) {
                        var g = e.actors[d];
                        c.vals[a.Constants.ParameterCode.IsInactive]
                            ? (g._setSuspended(!0), e.onActorSuspend(g))
                            : (e.removeActor(d), e.onActorLeave(g, !1));
                    }
                });
                f.addEventListener(
                    a.Constants.EventCode.Disconnect,
                    function (a) {
                        f._logger.debug('ev Disconnect', a);
                        (a = b._getActorNrFromResponse(a.vals)) &&
                            e.actors[a] &&
                            ((a = e.actors[a]),
                            a._setSuspended(!0),
                            e.onActorSuspend(a));
                ...
                f.addEventListener(
                    a.Constants.EventCode.PropertiesChanged,
                    function (c) {
                        ...
                        void 0 !== d && 0 < d
                            ? void 0 !== e.actors[d] &&
                              ((d = e.actors[d]),
                              d._updateCustomProperties(
                                  c.vals[a.Constants.ParameterCode.Properties]
                              ),
                              e.onActorPropertiesChange(d))
                            : (e.currentRoom._updateFromProps(
                                  c.vals[a.Constants.ParameterCode.Properties]
                              ),
                              e.onMyRoomPropertiesChange());
                    }
                );
            };
            ...
            d.prototype._cleanupGamePeerData = function () {
                for (var a in this.actors)
                    this.onActorLeave(this.actors[a], !0);
                this.clearActors();
                this.addActor(this._myActor);
            };
            ...
            d.prototype.initValidNextState = function () {
                this.validNextState[d.State.Error] = [
                    d.State.ConnectingToMasterserver,
                    d.State.ConnectingToNameServer
                ];
                this.validNextState[d.State.Uninitialized] = [
                    d.State.ConnectingToMasterserver,
                    d.State.ConnectingToNameServer
                ];
                this.validNextState[d.State.ConnectedToNameServer] = [
                    d.State.ConnectingToMasterserver
                ];
                this.validNextState[d.State.Disconnected] = [
                    d.State.ConnectingToMasterserver,
                    d.State.ConnectingToNameServer
                ];
                this.validNextState[d.State.ConnectedToMaster] = [
                    d.State.JoinedLobby
                ];
                this.validNextState[d.State.JoinedLobby] = [
                    d.State.ConnectingToGameserver
                ];
                this.validNextState[d.State.ConnectingToGameserver] = [
                    d.State.ConnectedToGameserver
                ];
                this.validNextState[d.State.ConnectedToGameserver] = [
                    d.State.Joined
                ];
            };
            ...
            d.JoinMode = { Default: 0, CreateIfNotExists: 1, Rejoin: 2 };
            d.PeerErrorCode = {
                Ok: 0,
                MasterError: 1001,
        ...
        l = (function (d) {
            ...
            f.prototype.webRpcHandler = function (c) {
                ...
                return function (d) {
                    ...
                    var f, b, g;
                    0 == d.errCode
                        ? ((f = d.vals[a.Constants.ParameterCode.UriPath]),
                          (b =
                              d.vals[a.Constants.ParameterCode.RpcCallRetData]),
                          (g =
                              d.vals[a.Constants.ParameterCode.RpcCallRetCode]))
                        : e._logger.error('WebRpc request error:', d.errCode);
        ...
        var r = (function (d) {
            ...
            f.prototype.onUnhandledEvent = function (c, e) {
                this.client.onEvent(
                    c,
                    e.vals[a.Constants.ParameterCode.CustomEventContent],
                    e.vals[a.Constants.ParameterCode.ActorNr]
                );
            };
            ...
            f.prototype.opAuth = function (c, e, d, f, b, g, h) {
                ...
                d != a.Constants.CustomAuthenticationType.None &&
                    (l.push(
                        a.Constants.ParameterCode.ClientAuthenticationType,
                        d
                    ),
                    l.push(
                        a.Constants.ParameterCode.ClientAuthenticationParams,
                        f
                    ),
                    b &&
                        l.push(
                            a.Constants.ParameterCode.ClientAuthenticationData,
                            b
                        ));
        ...
        var q = (function (d) {
            ...
            f.prototype.raiseEvent = function (c, e, d) {
                if (this.client.isJoinedToRoom()) {
                    ...
                    c = [
                        a.Constants.ParameterCode.Code,
                        c,
                        a.Constants.ParameterCode.Data,
                        e
                    ];
                    if (d) {
                        void 0 != d.receivers &&
                            d.receivers !== a.Constants.ReceiverGroup.Others &&
                            (c.push(a.Constants.ParameterCode.ReceiverGroup),
                            c.push(d.receivers));
                        void 0 != d.cache &&
                            d.cache !== a.Constants.EventCaching.DoNotCache &&
                            (c.push(a.Constants.ParameterCode.Cache),
                            c.push(d.cache));
                        if (void 0 != d.interestGroup)
                            if (this.checkGroupNumber(d.interestGroup))
                                c.push(a.Constants.ParameterCode.Group),
                                    c.push(d.interestGroup);
                            else
                                throw Error(
                                    'raiseEvent - Group not a number: ' +
                                        d.interestGroup
                                );
                        void 0 != d.targetActors &&
                            (c.push(a.Constants.ParameterCode.ActorList),
                            c.push(d.targetActors));
                        d.webForward &&
                            (c.push(a.Constants.ParameterCode.Forward),
                            c.push(!0));
                    }
            ...
            f.prototype.changeGroups = function (c, e) {
                ...
                null != c &&
                    void 0 != c &&
                    (this.checkGroupArray(c, 'groupsToRemove'),
                    d.push(a.Constants.ParameterCode.Remove),
                    d.push(c));
                null != e &&
                    void 0 != e &&
                    (this.checkGroupArray(e, 'groupsToAdd'),
                    d.push(a.Constants.ParameterCode.Add),
                    d.push(e));
            ...
            f.prototype.checkGroupArray = function (a, d) {
                if (Exitgames.Common.Util.isArray(a))
                    for (var f = 0; f < a.length; ++f) {
                        var b = a[f];
                        if (!this.checkGroupNumber(b))
                            throw Error(
                                'changeGroups - ' +
                                    d +
                                    ' (' +
                                    a +
                                    ') not an array of numbers: element ' +
                                    f +
                                    ' = ' +
                                    b
                            );
                    ...
                    throw Error(
                        'changeGroups - groupsToRemove not an array: ' + a
                    );
            };
            return f;
        })(l);
...
(function (k) {
    (function (a) {
        ...
        var b = (function (b) {
            ...
            g.prototype.onSubscribeResult = function (a) {};
            ...
            g.prototype.subscribe = function (b, g) {
                ...
                if (this.isConnectedToFrontEnd()) {
                    this.logger.debug('Subscribe channels:', b);
                    var h = [];
                    h.push(a.Constants.ParameterCode.Channels, b);
                    void 0 != g &&
                        0 != g &&
                        h.push(a.Constants.ParameterCode.HistoryLength, g);
                    this.masterPeer.sendOperation(
                        a.Constants.OperationCode.Subscribe,
                        h
                    );
                    return !0;
                }
            ...
            g.prototype.unsubscribe = function (b) {
                if (this.isConnectedToFrontEnd()) {
                    ...
                    this.masterPeer.sendOperation(
                        a.Constants.OperationCode.Unsubscribe,
                        g
                    );
                    return !0;
                }
                this.logger.error(
                    'unsubscribe request error:',
                    'Not connected to Front End'
                );
                return !1;
            };
            g.prototype.publishMessage = function (b, g) {
                if (this.isConnectedToFrontEnd()) {
                    ...
                    this.masterPeer.sendOperation(
                        a.Constants.OperationCode.Publish,
                        h
                    );
                    return !0;
                }
                this.logger.error(
                    'publishMessage request error:',
                    'Not connected to Front End'
                );
                return !1;
            };
            g.prototype.sendPrivateMessage = function (b, g) {
                if (this.isConnectedToFrontEnd()) {
                    ...
                    h.push(a.Constants.ParameterCode.Message, g);
                    this.masterPeer.sendOperation(
                        a.Constants.OperationCode.SendPrivate,
                        h
                    );
                    return !0;
                }
                this.logger.error(
                    'sendPrivateMessage request error:',
                    'Not connected to Front End'
                );
                return !1;
            };
            g.prototype.setUserStatus = function (b, g, h) {
                ...
                if (this.isConnectedToFrontEnd()) {
                    ...
                    h
                        ? k.push(a.Constants.ParameterCode.SkipMessage, !0)
                        : k.push(a.Constants.ParameterCode.Message, g);
                    this.masterPeer.sendOperation(
                        a.Constants.OperationCode.UpdateStatus,
                        k
                    );
                    return !0;
                }
                this.logger.error(
                    'setUserStatus request error:',
                    'Not connected to Front End'
                );
                return !1;
            };
            g.prototype.addFriends = function (b) {
                if (this.isConnectedToFrontEnd()) {
                    ...
                    this.masterPeer.sendOperation(
                        a.Constants.OperationCode.AddFriendds,
                        g
                    );
                    return !0;
                }
                this.logger.error(
                    'addFriends request error:',
                    'Not connected to Front End'
                );
                return !1;
            };
            g.prototype.removeFriends = function (b) {
                if (this.isConnectedToFrontEnd()) {
                    ...
                    g.push(a.Constants.ParameterCode.Friends, b);
                    this.masterPeer.sendOperation(
                        a.Constants.OperationCode.RemoveFriends,
                        g
                    );
                    return !0;
                }
                this.logger.error(
                    'removeFriends request error:',
                    'Not connected to Front End'
                );
                return !1;
            };
            ...
            g.prototype.initMasterPeer = function (g) {
                var k = this;
                b.prototype.initMasterPeer.call(this, g);
                g.addEventListener(
                    a.Constants.EventCode.ChatMessages,
                    function (b) {
                        ...
                        f
                            ? ((h = f.addMessages(h, d)),
                              k.onChatMessages(b, h))
                            : g._logger.warn(
                                  'ev ChatMessages: Got message from unsubscribed channel ',
                                  b
                              );
                    }
                );
                g.addEventListener(
                    a.Constants.EventCode.PrivateMessage,
                    function (b) {
                ...
                g.addEventListener(
                    a.Constants.EventCode.StatusUpdate,
                    function (b) {
                        var g = b.vals[a.Constants.ParameterCode.Message];
                        k.onUserStatusUpdate(
                            b.vals[a.Constants.ParameterCode.Sender],
                            b.vals[a.Constants.ParameterCode.Status],
                            void 0 !== g,
                            g
                        );
                    }
                ...
                g.addEventListener(
                    a.Constants.EventCode.Subscribe,
                    function (b) {
                        g._logger.debug('ev Subscribe', b);
                        var h = {},
                            d =
                                b.vals[a.Constants.ParameterCode.Channels] ||
                                [];
                        b =
                            b.vals[
                                a.Constants.ParameterCode.SubscribeResults
                            ] || [];
                        for (var f in d) {
                            var c = d[f];
                            h[c] = !1;
                            f < b.length &&
                                b[f] &&
                                (k.getOrAddChannel(k.publicChannels, c, !1),
                                (h[c] = !0));
                        }
                ...
                g.addEventListener(
                    a.Constants.EventCode.Unsubscribe,
                    function (b) {
            ...
            g.StateToName = function (a) {
                var b = Exitgames.Common.Util.getEnumKeyByValue(g.ChatState, a);
                return void 0 === b
                    ? Exitgames.Common.Util.getEnumKeyByValue(g.State, a)
                    : b;
            };
            g.ChatPeerErrorCode = {
                Ok: 0,
